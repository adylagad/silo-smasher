...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden">
      <div className="floating-blob absolute -top-28 -left-24 w-80 h-80 rounded-full bg-sky-500/20 pointer-events-none" />
      ...
      <div className="flex-1 min-h-0 relative overflow-hidden dot-bg">
        ...
        <div className="absolute inset-x-3 bottom-3 md:inset-x-auto md:right-5 md:bottom-5 md:w-[470px] z-20">
          {!chatOpen && (
            <form
              ...
              className="card rounded-2xl px-3 py-3"
            >
        ...
        {chatOpen && (
          <div className="absolute inset-3 md:inset-auto md:right-5 md:bottom-5 md:w-[min(900px,88vw)] md:h-[84vh] z-30 rounded-2xl border border-slate-300/20 bg-[#050b14]/94 backdrop-blur-xl shadow-[0_35px_90px_rgba(3,7,18,0.7)] overflow-hidden">
